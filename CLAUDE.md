...
- **Updating the agent guide** — workflow changes go in `dbt/optimist/CLAUDE.md`; it is the single source of truth for all consuming projects. `scaffold/CLAUDE.md` contains only project identity and a reference to the package doc — do not duplicate conventions there
...
- Modelling conventions (Kimball, materialization, CTE structure) live in `dbt/optimist/CLAUDE.md` and ship with the package — consuming projects reference `dbt_packages/optimist/CLAUDE.md`
